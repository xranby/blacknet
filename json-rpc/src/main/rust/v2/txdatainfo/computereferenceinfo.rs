...
use blacknet_kernel::transaction::ComputeReference;
use blacknet_serialization::format::from_bytes;
use serde::{Deserialize, Serialize};

/// RPC view of a ComputeReference transaction: its canonically-encoded
...
pub struct ComputeReferenceInfo {
    payload: ByteArrayInfo,
}

impl ComputeReferenceInfo {
    pub fn new(data: &[u8]) -> Result<Self> {
        let tx = from_bytes::<ComputeReference>(data, false)?;
        Ok(Self {
