...
use blacknet_kernel::transaction::VerifiedComputation;
use blacknet_serialization::format::from_bytes;
use serde::{Deserialize, Serialize};

/// RPC view of a VerifiedComputation transaction: its canonically-encoded
...
pub struct VerifiedComputationInfo {
    payload: ByteArrayInfo,
}

impl VerifiedComputationInfo {
    pub fn new(data: &[u8]) -> Result<Self> {
        let tx = from_bytes::<VerifiedComputation>(data, false)?;
        Ok(Self {
